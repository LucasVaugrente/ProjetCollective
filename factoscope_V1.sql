...
CREATE TABLE IF NOT EXISTS `mot` (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_motscroises` int NOT NULL,
  `mot` text NOT NULL,
  `indice` text NOT NULL,
  `direction` text NOT NULL,
  `position_depart_x` int NOT NULL,
  `position_depart_y` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `id_motscroises` (`id_motscroises`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- --------------------------------------------------------

--
-- Structure de la table `motscroises`
--

DROP TABLE IF EXISTS `motscroises`;
CREATE TABLE IF NOT EXISTS `motscroises` (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_minijeu` int NOT NULL,
  `taille_grille` text NOT NULL,
  `description` text,
  PRIMARY KEY (`id`),
  KEY `id_minijeu` (`id_minijeu`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
